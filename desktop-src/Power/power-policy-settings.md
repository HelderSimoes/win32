...
> [!Note]  
> Devices that support [Modern Standby](/windows-hardware/design/device-experiences/modern-standby) mode only allow the Power Plans with Balanced Personality. **Modern Standby** is the newer, more streamlined solution to power settings management.
